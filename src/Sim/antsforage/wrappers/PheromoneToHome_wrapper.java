...
public class PheromoneToHome_wrapper extends SimObject_wrapper {
    ...
    static private final String class_name = "PheromoneToHome";
...
//            AntsForage.toHomeGrid.field[(int)((JSONObject)c).get("x")][(int)((JSONObject)c).get("y")] = (double)((JSONObject)((JSONObject)g_u).get("params")).get("intensity");  /// Intensità del feromone
//        }
